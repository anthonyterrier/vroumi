...
export const DTC_DESCRIPTIONS: Record<string, string> = {
  ...
  P0170: "Dosage carburant (rangée 1)",
  P0171: "Système trop pauvre (rangée 1)",
  P0172: "Système trop riche (rangée 1)",
  P0173: "Dosage carburant (rangée 2)",
  P0174: "Système trop pauvre (rangée 2)",
  P0175: "Système trop riche (rangée 2)",
  P0325: "Capteur de cliquetis 1 – circuit",
  P0330: "Capteur de cliquetis 2 – circuit",
  // Ratés d'allumage
  ...
  P0421: "Catalyseur de préchauffage – rendement sous le seuil (rangée 1)",
  P0422: "Catalyseur principal – rendement sous le seuil (rangée 1)",
  P0423: "Catalyseur chauffé – rendement sous le seuil (rangée 1)",
  P0430: "Rendement catalyseur sous le seuil (rangée 2)",
  P0431: "Catalyseur de préchauffage – rendement sous le seuil (rangée 2)",
  P0432: "Catalyseur principal – rendement sous le seuil (rangée 2)",
